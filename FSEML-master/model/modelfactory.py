        ...
        if "Sin" == dataset:          
            ...
            if model_type == "Neuromodulation":
                ...
                return [
                    ...
                    ('conv2d', [auto_channels, 3, 3, 3, 3, 1]),                                                       
                    ('auto_bn1', [auto_channels]),
                    ('max_pool2d', [2, 2, 0]),                              
                    ('conv2d', [auto_channels//2, auto_channels, 3, 3, 2, 1]),                     
                    ('auto_bn2', [8]),
                    ...
                    ('convt2d', [auto_channels//2, auto_channels, 3, 3, 2, 0]),
                    ('relu', [True]),
                                               
                    ('convt2d', [auto_channels, 3, 8, 8, 3, 1]),                                                        
